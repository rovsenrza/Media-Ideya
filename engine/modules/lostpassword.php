...
$canonical = $_SERVER['SCRIPT_NAME']."?do=lostpassword";
...
if( $is_logged ) {
	...
	if ( $config['allow_recaptcha'] ) {
		...
		$tpl->set( '{code}', "<a onclick=\"reload(); return false;\" href=\"#\" title=\"{$lang['reload_code']}\"><span id=\"dle-captcha\"><img src=\"{$path['path']}index.php?controller=antibot\" alt=\"{$lang['reload_code']}\" border=\"0\" width=\"160\" height=\"80\"></span></a>" );
