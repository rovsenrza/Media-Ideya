...
function doVote( event ){
	...
	$.get(dle_root + "index.php?controller=ajax&mod=vote", { vote_id: "{$rid}", vote_action: event, vote_check: vote_check, vote_skin: dle_skin, user_hash: dle_login_hash }, function(data){
