...
function cal($cal_month, $cal_year, $events) {
	...
	$buffer = '<table id="calendar" class="calendar"><tr><th colspan="7" class="monthselect"><div class="monthselect-inner">' . $date_link['prev'] . '<span class="monthselect-title">' . langdate( 'F', $first_of_month, true ) . ' ' . $cal_year . '</span>' . $date_link['next'] . '</div></th></tr><tr>';
