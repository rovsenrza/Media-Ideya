...
if( $action == "list" ) {
	...
	while ($row = $db->get_row()) {
		...
		if ($row['news_num'] == 0) {
			...
			$url_user =  DLEUrl::BuildUrl('user.news', ['user' => urlencode($row['name'])]);
...
HTML;
       ...
       <div class="btn-group">
				...
				<ul class="dropdown-menu text-left dropdown-menu-right">
				  <li><a href="{$plink}" target="_blank"><i class="fa fa-external-link position-left"></i>{$lang['header_profile']}</a></li>
  ...
  <div class="panel-heading">
    ...
    <table class="table table-xs table-hover">
      ...
      <tr>
        ...
        <th class="hidden-xs text-center" style="width: 2.78em"><i class="fa fa-file-text-o  tip" data-original-title="{$lang['rss_maxnews']}"></i></th>
        <th class="hidden-xs text-center" style="width: 2.78em"><i class="fa fa-comments-o tip" data-original-title="{$lang['edit_com']}"></i></th>
        <th style="width: 4.86em">&nbsp;</th>
        <th class="hidden-xs" style="width: 2.78em"><input type="checkbox" name="master_box" class="icheck" title="{$lang['edit_selall']}" onclick="javascript:ckeck_uncheck_all_self()"></th>
      </tr>
      </thead>
	  <tbody>
		{$wait_for_delete}
...
<script>
    function sendNotice( id, mass = false ){
		...
		$('body').append("<div id='dlepopup' class='dle-promt' title='{$lang['p_title']}' style='display:none'>{$lang['selfdel_text']}<br><br><textarea dir='auto' name='dle-promt-text' id='dle-promt-text' class='classic' style='width:100%;padding: .4em;' rows='4'></textarea></div>");
	...
	<input type="hidden" name="mod" value="editusers">
	  ...
	  <div class="modal-body">
		...
		<div class="form-group">
		  ...
		  <div class="col-sm-4">
			{$lang['edit_fdate']}&nbsp;<input data-rel="calendardate" type="text" dir="auto" name="fromregdate" class="form-control" style="width:9.72em;" value="" autocomplete="off">
		  </div>
		  <div class="col-sm-4">
			{$lang['edit_tdate']}&nbsp;<input data-rel="calendardate" type="text" dir="auto" name="toregdate" class="form-control" style="width:9.375em;" value="" autocomplete="off">
		  </div>
		 </div>
		<div class="form-group">
		  <label class="control-label col-sm-4">{$lang['edit_entedate']}</label>
		  <div class="col-sm-4">
			{$lang['edit_fdate']}&nbsp;<input data-rel="calendardate" type="text" dir="auto" name="fromentdate" class="form-control" style="width:9.72em;" value="" autocomplete="off">
		  </div>
		  <div class="col-sm-4">
			{$lang['edit_tdate']}&nbsp;<input data-rel="calendardate" type="text" dir="auto" name="toentdate" class="form-control" style="width:9.375em;" value="" autocomplete="off">
		  </div>
		 </div>
		<div class="form-group">
		  <div class="col-sm-6">
  ...
  <div class="panel-body">
	  ...
	  <div class="col-md-6">
		...
		<div class="form-group">
		  ...
		  <div class="col-md-5">
			<input class="form-control text-center" style="width:12.85em;" type="text" dir="auto" name="news_per_page" id="news_per_page" value="{$news_per_page}">
		  </div>
		 </div>
	  ...
	  <div class="col-md-6">
		<div class="form-group">
		  ...
		  <div class="col-md-8">
			{$lang['edit_fdate']}&nbsp;<input class="form-control" style="width:9.72em;" data-rel="calendardate" type="text" dir="auto" name="fromregdate" id="fromregdate" value="{$fromregdate}" autocomplete="off">
			{$lang['edit_tdate']}&nbsp;<input class="form-control" style="width:9.72em;" data-rel="calendardate" type="text" dir="auto" name="toregdate" id="toregdate" value="{$toregdate}" autocomplete="off">
		  </div>
		 </div>
		<div class="form-group">
		  <label class="control-label col-md-4">{$lang['edit_entedate']}</label>
		  <div class="col-md-8">
			{$lang['edit_fdate']}&nbsp;<input class="form-control" style="width:9.72em;" data-rel="calendardate" type="text" dir="auto" name="fromentdate" id="fromentdate" value="{$fromentdate}" autocomplete="off">
			{$lang['edit_tdate']}&nbsp;<input class="form-control" style="width:9.72em;" data-rel="calendardate" type="text" dir="auto" name="toentdate" id="toentdate" value="{$toentdate}" autocomplete="off">
		  </div>
	    </div>
		<div class="form-group">
 	   <label class="control-label col-md-4">{$lang['edit_newsnum']}</label>
		  <div class="col-md-8">
			{$lang['edit_fdate']}&nbsp;<input class="form-control text-center" style="width:4.86em;" type="text" dir="auto" name="search_news_f" id="search_news_f" value="{$search_news_f}">
			{$lang['edit_tdate']}&nbsp;<input class="form-control text-center" style="width:4.86em;" type="text" dir="auto" name="search_news_t" id="search_news_t" value="{$search_news_t}">
		  </div>
		 </div>
		<div class="form-group">
		  <label class="control-label col-md-4">{$lang['edit_comsnum']}</label>
		  <div class="col-md-8">
			{$lang['edit_fdate']}&nbsp;<input class="form-control text-center" style="width:4.86em;" type="text" dir="auto" name="search_coms_f" id="search_coms_f" value="{$search_coms_f}">
		    {$lang['edit_tdate']}&nbsp;<input class="form-control text-center" style="width:4.86em;" type="text" dir="auto" name="search_coms_t" id="search_coms_t" value="{$search_coms_t}">
	      </div>
		 </div>
  ...
  <div class="panel-heading">
    ...
    <table class="table table-xs table-hover">
      ...
      <tr>
        ...
        <th class="hidden-xs text-center" style="width: 2.78em"><i class="fa fa-comments-o tip" data-original-title="{$lang['edit_com']}"></i></th>
        <th style="width: 4.86em">&nbsp;</th>
        <th class="hidden-xs" style="width: 2.78em"><input type="checkbox" name="master_box" class="icheck" title="{$lang['edit_selall']}" onclick="javascript:ckeck_uncheck_all()"></th>
      </tr>
      </thead>
	  <tbody>
HTML;
...
HTML;
	...
	if( !check_referer($_SERVER['SCRIPT_NAME']."?mod=editusers") ) {
	...
	$regemail = $db->safesql(sanitize_email($_POST['regemail']));

	if( !is_valid_email(stripslashes($regemail)) ) {
	...
	if( isset($row['email']) AND $row['email'] == stripslashes($regemail) ) {
	...
	if ( !$skin ) {
		...
		while ( $temp_row = $db->get_row( $temp_result ) ) {
			...
			$user_name = "<a href=\"" . DLEUrl::BuildUrl('user', ['user' => urlencode($temp_row['user_from'])]) . "\" target=\"_blank\">" . $temp_row['user_from'] . "</a>";
		...
		$xfields = DLEUserXFields::FieldsList($row);

		if( isset($xfields['fields']) AND count($xfields['fields']) ) $xfields = implode('', $xfields['fields'] ); else $xfields = '';
...
function onTwofactoryChange( obj, allowchange ) {
	...
	if (value && value == 2 && value != prev_value) {
		...
		$.get("index.php?controller=ajax&mod=twofactor", { mode: 'createsecret', user_hash: dle_login_hash }, function (data) {
			...
			b[dle_act_lang[2]] = function () {
				if ($("#dle-promt-text").val().length < 1) {
					...
					$.post("index.php?controller=ajax&mod=twofactor", { mode: 'verifysecret', pin: pin, user_hash: dle_login_hash }, function (data) {
			...
			$('#dletwofactorsecret').dialog({
				...
				classes: {
					"ui-dialog": "dle-popup-twofactor-secret"
				},				
				buttons: b
			});
...
function DelIgnorePM( id, text ){
    ...
    DLEconfirm( text, '{$lang['p_confirm']}', function () {
		...
		$.get("index.php?controller=ajax&mod=adminfunction", { id: id, action: "del_ignore", user_hash: '{$dle_login_hash}', skin: '{$config['skin']}' }, function(data){
...
function DLESendPM( name ) {
	...
	b['{$lang['p_send']}'] = function() {
		...
		if ( dle_captcha_type == "1" ) {
			...
			if (typeof window.smartCaptcha != "undefined") {
				g_recaptcha_response = window.smartCaptcha.getResponse(recaptcha_widget);
			}
		}
		...
		$.post("index.php?controller=ajax&mod=pm", { action: 'send_pm', subj: subj, comments: comments, name: name, sec_code: sec_code, question_answer: question_answer, g_recaptcha_response: g_recaptcha_response, user_hash: '{$dle_login_hash}'}, function(data){
	...
	$.get("index.php?controller=ajax&mod=pm", { name: name, action: 'show_send', user_hash: '{$dle_login_hash}'}, function(data){
		...
		$('#dlesendpmpopup').dialog({
			...
			classes: {
				"ui-dialog": "modalfixed dle-popup-sendpm"
			},			
			buttons: b
		});
...
echo <<<HTML
				...
				<div class="form-group">
				  ...
				  <div class="col-md-9 col-sm-9">
					<input class="form-control" type="text" dir="auto" style="width:15.28em;" data-rel="calendardatetime" name="time_limit" id="time_limit" value="{$row['time_limit']}" autocomplete="off">
				  </div>
				 </div>
				<div class="list-group-divider"></div>
				<div class="form-group">
				...
				<div class="form-group">
				  ...
				  <div class="col-md-9 col-sm-9">
					<input class="form-control" style="width:3.472em;" type="text" dir="auto" name="banned_date" value="{$row['days']}"> {$endban}
				  </div>
				 </div>
				<div class="form-group">
				  <label class="control-label col-md-3 col-sm-3">{$lang['ban_descr']}</label>
				  <div class="col-md-9 col-sm-9">
					<textarea dir="auto" style="width:100%;" name="banned_descr" class="classic" rows="3">{$row['descr']}</textarea>
					{$banned_from}
				  </div>
				 </div>
				<div class="list-group-divider"></div>
				...
				<div class="form-group">
				  ...
				  <div class="col-md-9 col-sm-9">
					<input class="form-control" style="width:3.472em;" name="restricted_days" type="text" dir="auto" value="{$row['restricted_days']}"> {$end_restricted}
				  </div>
				 </div>
				<div class="list-group-divider"></div>
				<div class="form-group">
				  ...
				  <div class="col-md-9 col-sm-9">
					<select data-placeholder="{$lang['addnews_cat_sel']}" name="cat_allow_addnews[]" style="width:100%; max-width:24.31em;" class="cat_select" multiple ><option value="" {$cat_allow_addnews_value}>{$lang['ng_group']}</option>{$cat_allow_addnews_list}</select>
				...
				<div class="form-group">
				  ...
				  <div class="col-md-9 col-sm-9">
					<select data-placeholder="{$lang['addnews_cat_sel']}" name="cat_add[]" style="width:100%; max-width:24.31em;" class="cat_select" multiple ><option value="" {$cat_add_value}>{$lang['ng_group']}</option>{$cat_add_list}</select>
...
echo <<<HTML
				...
				<div class="form-group">
				  ...
				  <div class="col-md-9 col-sm-9">
					<input type="file" name="image" style="width:21.11em;" class="icheck">
				  </div>
				 </div>
				<div class="form-group">
...
HTML;
		...
		$comments_link = "<a href=\"{$config['http_home_url']}index.php?do=lastcomments&userid={$row['user_id']}\" class=\"btn bg-slate-600 btn-sm btn-raised legitRipple mb-5 mt-5\" target=\"_blank\"><i class=\"fa fa-external-link position-left\"></i>" . $lang['see_user_comments'] . "</a>";
		$news_link = "<a href=\"" . DLEUrl::BuildUrl('user.news', ['user' => urlencode($row['name'])]) . "\" class=\"btn bg-slate-600 btn-sm btn-raised legitRipple mb-5 mt-5\" target=\"_blank\"><i class=\"fa fa-external-link position-left\"></i>" . $lang['see_user_news'] . "</a>";
		$profile_link = "<a href=\"" . DLEUrl::BuildUrl('user', ['user' => urlencode($row['name'])]) . "\" class=\"btn bg-slate-600 btn-sm btn-raised legitRipple mb-5 mt-5\" target=\"_blank\"><i class=\"fa fa-external-link position-left\"></i>" . $lang['header_profile'] . "</a>";
		...
		echo <<<HTML
				<div class="form-group">
				  ...
				  <div class="col-md-9 col-sm-9">
					<textarea dir="auto" style="width:100%;" name="allowed_ip" class="classic" rows="3">{$row['allowed_ip']}</textarea>
				  </div>
				 </div>
				<div class="form-group">
				...
				<div class="form-group">
				  ...
				  <div class="col-md-9 col-sm-9">
					<textarea dir="auto" style="width:100%;" name="editinfo" class="classic" rows="3">{$row['info']}</textarea>
				  </div>
				 </div>
				<div class="form-group">
				  <label class="control-label col-md-3 col-sm-3">{$lang['extra_signature']}</label>
				  <div class="col-md-9 col-sm-9">
					<textarea dir="auto" style="width:100%;" name="editsignature" class="classic" rows="3">{$row['signature']}</textarea>
				  </div>
				 </div>
				 {$xfields}
				<div class="form-group">
		...
		<div class="panel">
			...
			<div class="panel-body">
				<div class="row" style="white-space: nowrap;text-overflow: ellipsis;overflow: hidden;">
					...
					<div class="col-sm-12 text-center">{$profile_link}</div>
...
<script src="public/calendar/calendar.js"></script>
</head>
<body>
<script>
<!--
...
function confirmDelete(url){
	...
	parent.DLEconfirmDelete( '{$lang['user_deluser']}', '{$lang['p_confirm']}', function () {
		...
		document.location='{$_SERVER['SCRIPT_NAME']}?mod=editusers&action=dodeleteuser&popup=yes&skin={$skin}&id={$row['user_id']}&user_hash='+url;
...
HTML;
		...
		$xfields = DLEUserXFields::FieldsList($row, 'admin');

		if( isset($xfields['fields']) AND count($xfields['fields']) ) {
			
			$xfields = '<tr><td colspan="3"><hr></td></tr>'.implode('', $xfields['fields'] ); 
...
<table width="99%">
    <tr>
        <td width="150" style="padding:.26em;">{$lang['user_name']}</td>
        <td>{$row['name']}</td>
        <td rowspan="6" valign="top" align="right">{$avatar}</td>
    </tr>
    <tr>
        <td style="padding:.26em;">IP:</td>
        <td><a href="#" onclick="parent.document.location='?mod=iptools&ip={$row['logged_ip']}'; return false;">{$row['logged_ip']}</a></td>
    </tr>
    <tr>
        <td style="padding:.26em;">{$lang['user_news']}</td>
        <td>{$row['news_num']}</td>
    </tr>
    <tr>
        <td style="padding:.26em;">{$lang['user_last']}</td>
        <td>{$last_date}</td>
    </tr>
    <tr>
        <td style="padding:.26em;">{$lang['user_reg']}</td>
        <td>{$reg_date}</td>
    </tr>
    <tr>
        <td style="padding:.26em;">{$lang['user_mail']}</td>
    ...
    <tr>
        <td style="padding:.26em;">{$lang['user_newlogin']}</td>
        <td colspan="2"><input dir="auto" size="30" name="editlogin" class="edit bk"></td>
    </tr>
    <tr>
        <td style="padding:.26em;">{$lang['user_newpass']}</td>
    ...
    <tr>
        <td style="padding:.26em;">{$lang['user_acc']}</td>
        <td colspan="2"><select name="editlevel">{$group_list}</select></td>
    </tr>
    <tr>
        <td style="padding:.26em;">{$lang['user_gtlimit']}</td>
    ...
    <tr>
        <td style="padding:.26em;">{$lang['user_banned']}</td>
        <td colspan="2"><input type="checkbox" name="banned" value="yes" $ifch></td>
    </tr>
    <tr>
        <td style="padding:.26em;">{$lang['ban_date']}</td>
        <td colspan="2"><input dir="auto" size="5" name="banned_date" class="edit bk" value="{$row['days']}"> {$endban}</td>
    </tr>
    <tr>
        <td style="padding:.26em;">{$lang['ban_descr']}</td>
        <td colspan="2"><textarea dir="auto" style="width:100%;" name="banned_descr" class="bk" rows="3">{$row['descr']}</textarea>{$banned_from}</td>
    </tr>
    <tr>
        <td colspan="3"><hr></td>
    </tr>
    <tr>
        <td style="padding:.26em;">{$lang['restricted']}</td>
...
<option value="3" $restricted_selected[3]>{$lang['restricted_all']}</option>
    ...
    <tr>
        <td style="padding:.26em;">{$lang['restricted_date']}</td>
    ...
    <tr>
        <td style="padding:.26em;">{$lang['user_del_comments']}</td>
    ...
    <tr>
        <td style="padding:.26em;">Gravatar:</td>
        <td colspan="2"><input dir="auto" size="30" name="gravatar" value="{$gravatar}" class="edit bk"></td>
    </tr>
    <tr>
        <td style="padding:.26em;">{$lang['user_avatar']}</td>
        <td colspan="2"><input type="file" name="image" style="width:21.11em;" class="edit" /></td>
    </tr>
    <tr>
        <td style="padding:.26em;">{$lang['user_del_avatar']}</td>
    ...
    <tr>
        <td style="padding:.26em;">{$lang['extra_minfo']}</td>
        <td colspan="2" style="padding-bottom:.26em;"><textarea dir="auto" style="width:100%;" name="editinfo" class="bk" rows="3">{$row['info']}</textarea></td>
    </tr>
    <tr>
        <td style="padding:.26em;">{$lang['extra_signature']}</td>
        <td colspan="2"><textarea dir="auto" style="width:100%;" name="editsignature" class="bk" rows="3">{$row['signature']}</textarea></td>
    </tr>
	{$xfields}
    <tr>
        <td colspan="3"><hr></td>
    ...
    <tr>
        <td style="padding:.26em;">{$lang['opt_sys_at']}</td>
        <td colspan="2">{$timezoneselect}</td>
    </tr>
    <tr>
        <td style="padding:.26em;">{$lang['allowed_ip']}</td>
        <td colspan="2"><textarea dir="auto" style="width:100%;" name="allowed_ip" class="bk" rows="3">{$row['allowed_ip']}</textarea></td>
    </tr>
    <tr>
        <td style="padding:.26em;">{$lang['ignore_list']}</td>
...
HTML;
	...
	if( !$row['user_id'] ) {
		...
		if(isset($_POST['popup']) AND $_POST['popup']) die( "User not found" );
	...
	if ($member_id['user_group'] != 1 AND $row['user_group'] == 1 ) {
		...
		if(isset($_POST['popup']) AND $_POST['popup']) die( $lang['edit_not_admin'] );
    ...
    if($_POST['editmail']) {
		...
		$editmail = $db->safesql(sanitize_email($_POST['editmail']));
		
		if( !is_valid_email(stripslashes($editmail)) ) {
			
			if(isset($_POST['popup']) AND $_POST['popup']) die( $lang['mail_error'] );
			else msg( "error", array($_SESSION['admin_user_referrer'] => $lang['user_head'], '' => $lang['user_err']), $lang['mail_error'], "javascript:history.go(-1)" );
			
		}
		
		if (stripslashes($editmail) != $row['email']) {
	
			if ( $db->num_rows( $db->query( "SELECT user_id FROM " . USERPREFIX . "_users WHERE email = '{$editmail}'" ) ) ) {
				if(isset($_POST['popup']) AND $_POST['popup']) die( $lang['user_err_4'] );
	...
	if( $user_group[$member_id['user_group']]['admin_editusers'] ) {
		...
		if ($member_id['user_group'] != 1 AND $editlevel < 2 ){
			...
			if(isset($_POST['popup']) AND $_POST['popup']) die( $lang['admin_not_access'] );
		...
		if( $_POST['editlogin'] ) {
			...
			if( trim( $editlogin ) ) {
				...
				if( !isset($find_user['user_id']) ) {
					...
					if(isset($_POST['popup']) AND $_POST['popup']) die( $lang['user_edit_found'] );
	...
	if ( isset($_POST['gravatar']) AND $_POST['gravatar'] ) {
		...
		if ( filter_var($row['foto'], FILTER_VALIDATE_EMAIL) ) $sets[] = "foto=''";
	...
	$sets[] = "xfields='". DLEUserXFields::Parse('') . "'";
...
<table width="100%">
	<tr>
	<td style="padding:.26em;" colspan="2">{$lang['set_new_name']}</td>
	</tr>
	<tr>
		<td width="230" style="padding:.26em;">{$lang['edit_selauthor_2']}</td>
		<td><input dir="auto" size="40" name="new_username" class="edit bk"></td>
	</tr>
	<tr>
	<td style="padding:.26em;" colspan="2"><input type="submit" value="{$lang['b_start']}">
...
HTML;
	...
	<div class="panel panel-default">
	  ...
	  <div class="panel-body">
			<table width="100%">
				<tr>
					<td height="100" class="text-center"><div class="alert alert-warning alert-styled-left text-left">{$lang['set_new_name']}</div>{$lang['edit_selauthor_2']}<input type="text" dir="auto" name="new_username" class="form-control position-left position-right" style="width:13.89em;">
					<input type="hidden" name="action" value="dodeleteuser">
					<input type="hidden" name="mod" value="editusers">
					<input type="hidden" name="id" value="{$row['user_id']}">
