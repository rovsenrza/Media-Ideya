...
<table width="100%">
    <tr>
        <td style="height:3.47em;"><div align="center">{$lang['links_not_found']}</div></td>
    </tr>
</table>
</div>
...
<!--
	...
	function addLink() {
		...
		$("body").append("<div id='dlepopup' title='{$lang['add_links_new']}' style='display:none'>{$lang['add_links_tag']}<br><input type='text' dir='auto' name='dle-promt-tag' id='dle-promt-tag' class='form-control' style='width:100%;' value=''><br><br>{$lang['add_links_url']}<br><input type='text' dir='auto' name='dle-promt-url' id='dle-promt-url' class='form-control' style='width:100%;' value='http://'><br><br>{$lang['bb_url_tooltip']}<br><input type='text' dir='auto' name='dle-promt-title' id='dle-promt-title' class='form-control' style='width:100%;' value=''><br><br>{$lang['links_rcount']} <input type='text' dir='auto' name='dle-rcount' id='dle-rcount' class='form-control' style='width:3.47em;' value='0'> {$lang['links_rcount_1']}<br><br>{$lang['links_area_1']} <select name='replacearea' id='replacearea' class='dropup uniform' data-dropup-auto='false'><option value='1'>{$lang['links_area_2']}</option><option value='2'>{$lang['links_area_3']}</option><option value='3'>{$lang['links_area_4']}</option><option value='4'>{$lang['links_area_5']}</option><option value='5'>{$lang['links_area_8']}</option><option value='6'>{$lang['links_area_9']}</option></select><br><br><label class='checkbox-inline margin-left'><input type='checkbox' class='icheck' name='only-one' id='only-one' value=''>{$lang['add_links_one']}</label>&nbsp;&nbsp;&nbsp;<label class='checkbox-inline margin-left'><input type='checkbox' class='icheck' name='targetblank' id='targetblank' value=''>{$lang['links_target']}</label></div>");
...
$(function(){
		...
		$('.editlink').click(function(){
			...
			$("body").append("<div id='dlepopup' title='{$lang['add_links_new']}' style='display:none'>{$lang['add_links_tag']}<br><input type='text' dir='auto' name='dle-promt-tag' id='dle-promt-tag' class='form-control' style='width:100%;' value=\""+tag+"\"/><br><br>{$lang['add_links_url']}<br><input type='text' dir='auto' name='dle-promt-url' id='dle-promt-url' class='form-control' style='width:100%;' value='"+url+"'><br><br>{$lang['bb_url_tooltip']}<br><input type='text' dir='auto' name='dle-promt-title' id='dle-promt-title' class='form-control' style='width:100%;' value='"+title+"'><br><br>{$lang['links_rcount']} <input type='text' dir='auto' name='dle-rcount' id='dle-rcount' class='form-control' style='width:3.47em;' value='"+rcount+"'> {$lang['links_rcount_1']}<br><br>{$lang['links_area_1']} <select name='replacearea' id='replacearea' class='dropup uniform' data-dropup-auto='false'><option value='1'>{$lang['links_area_2']}</option><option value='2'>{$lang['links_area_3']}</option><option value='3'>{$lang['links_area_4']}</option><option value='4'>{$lang['links_area_5']}</option><option value='5'>{$lang['links_area_8']}</option><option value='6'>{$lang['links_area_9']}</option></select><br><br><label class='checkbox-inline margin-left'><input type='checkbox' class='icheck' name='only-one' id='only-one' value=''>{$lang['add_links_one']}</label>&nbsp;&nbsp;&nbsp;<label class='checkbox-inline margin-left'><input type='checkbox' class='icheck' name='targetblank' id='targetblank' value=''>{$lang['links_target']}</label><input type='hidden' name='url-id' id='url-id' value='"+urlid+"'></div>");
