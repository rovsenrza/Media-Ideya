...
<script>
	...
	function doFull( link, news_id, rss_id )
	{
		...
		$.post('index.php?controller=ajax&mod=rss', { link: link, news_id: news_id, rss_id: rss_id, user_hash: '{$dle_login_hash}', rss_charset: "{$xml->rss_charset}" }, function(data){
...
HTML;
	...
	<div class="col-md-10"><input class="form-control" autocomplete="off" style="width:13.19em;" data-rel="calendar" type="text" dir="auto" name="content[' . $i . '][date]" value="' . $content['date'] . '"></div>
	</div>
	<div class="form-group">
    ...
    <td>
    <div class="editor-panel"><textarea dir="auto" class="' . $editor_class . '" style="width:100%;max-width:66em;height:13.89em;" id="short_' . $i . '" name="content[' . $i . '][short]"' . $extra_textarea . '>' . $content['description'] . '</textarea></div>
...
HTML;
		...
		echo "<div style=\"padding:.694em;\" align=\"center\">" . $lang['rss_no_rss'] . "<br><br><a class=\"btn bg-teal btn-sm btn-raised\" href=\"?mod=rss\">{$lang['func_msg']}</a></div>";
...
HTML;
	...
	function makeDropDown($options, $name, $selected) {
		$output = "<select class=\"uniform\" style=\"min-width:6.94em;\" name=\"$name\">\r\n";
