...
if ($_POST['action'] == "replace") {
	...
	$_POST['find'] = isset($_POST['find']) ? trim($_POST['find']) : "";
	$_POST['replace'] = isset($_POST['replace']) ? trim($_POST['replace']) : "";
	...
	if (!$find OR !isset($_POST['table']) OR !is_array($_POST['table']) OR !count($_POST['table'])) {
  ...
  <div class="panel-heading">
	...
	<div class="panel-body">
		...
		<div class="form-group">
		  ...
		  <div class="col-md-10 col-sm-9">
			<textarea dir="auto" name="find" class="classic width-550" rows="7"></textarea>
		   </div>
	    </div>
		<div class="form-group">
		  <label class="control-label col-md-2 col-sm-3">{$lang['find_rtext']}</label>
		  <div class="col-md-10 col-sm-9">
			<textarea dir="auto" name="replace" class="classic width-550" rows="7"></textarea>
		   </div>
	    </div>
