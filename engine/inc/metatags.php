...
<table width="100%">
    <tr>
        <td style="height:3.47em;"><div align="center"><br /><br />{$lang['meta_not_found']}<br /><br></div></td>
    </tr>
</table>
</div>
<div class="panel-footer">
...
<!--
	...
	function addLink() {
		...
		$("body").append("<div id='dlepopup' title='{$lang['add_links_meta']}' style='display:none'><form id='addtags' method='post'><input type='hidden' name='mod' value='metatags'><input type='hidden' name='action' value='add'><input type='hidden' name='user_hash' value='{$dle_login_hash}'><input type='text' dir='auto' name='url' id='dle-promt-url' class='form-control' style='width:100%;' value=''placeholder='{$lang['meta_param_1']}'><br><br>{$lang['page_header_1']}<br><input type='text' dir='auto' name='page_title' class='form-control' style='width:100%;' value=''><br><br>{$lang['page_header_2']}<br><textarea dir='auto' name='page_description' class='classic' style='width:100%;' rows='3' placeholder='{$lang['page_header_3']}'></textarea><br><br>{$lang['meta_title']}<br><input type='text' dir='auto' name='meta_title' class='form-control' style='width:100%;' value=''><br><br>{$lang['meta_descr']}<br><input type='text' dir='auto' name='descr' class='form-control' style='width:100%;' value=''><br><br>{$lang['meta_keys']}<br><input type='text' dir='auto' name='keywords' class='form-control' style='width:100%;' value='' id='dle-promt-keywords'><br><br>{$lang['meta_robots']}<br><input type='text' dir='auto' name='robots' class='form-control' style='width:100%;' value=\"\"></form></div>");
