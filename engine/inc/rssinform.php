...
<div class="panel panel-default">
  ...
  <div class="panel-body">
		...
		<div class="form-group">
		  <label class="control-label col-md-3 col-sm-3">{$lang['rssinform_xname']}</label>
		...
		<div class="form-group">
		  <label class="control-label col-md-3 col-sm-3">{$lang['rssinform_xdescr']}</label>
		  <div class="col-md-9 col-sm-9">
			<input class="form-control width-350" maxlength="250" type="text" dir="auto" name="rss_descr" value="{$rss_descr}" />
		  </div>
		 </div>
		<div class="form-group">
		  <label class="control-label col-md-3 col-sm-3">{$lang['addnews_cat']}</label>
		  <div class="col-md-9 col-sm-9">
   ...
   {$opt_category}
		...
		<div class="form-group">
		  <label class="control-label col-md-3 col-sm-3">{$lang['rssinform_url']}</label>
		  <div class="col-md-9 col-sm-9">
			<input class="form-control width-350" maxlength="250" type="text" dir="auto" name="rss_url" value="{$rss_url}" />
		  </div>
		 </div>
		<div class="form-group">
		  <label class="control-label col-md-3 col-sm-3">{$lang['opt_sys_an']}</label>
		  <div class="col-md-9 col-sm-9">
		...
		<div class="form-group">
		  <label class="control-label col-md-3 col-sm-3">{$lang['rssinform_template']}</label>
		  <div class="col-md-9 col-sm-9">
			<input class="form-control width-200" maxlength="40" type="text" dir="auto" name="rss_template" value="{$rss_template}" /> .tpl
		  </div>
		 </div>
		<div class="form-group">
		  <label class="control-label col-md-3 col-sm-3">{$lang['rssinform_max']}</label>
		  <div class="col-md-9 col-sm-9">
			<input class="form-control" style="width: 4.17em;" type="text" dir="auto" name="rss_max" value="{$rss_max}" /><i class="help-button visible-lg-inline-block text-primary-600 fa fa-question-circle position-right position-left" data-rel="popover" data-trigger="hover" data-placement="auto right" data-content="{$lang['hint_ri_max']}" ></i>
		  </div>
		 </div>
		<div class="form-group">
		  <label class="control-label col-md-3 col-sm-3">{$lang['rssinform_tmax']}</label>
		  <div class="col-md-9 col-sm-9">
			<input class="form-control" style="width: 4.17em;" type="text" dir="auto" name="rss_tmax" value="{$rss_tmax}" /><i class="help-button visible-lg-inline-block text-primary-600 fa fa-question-circle position-right position-left" data-rel="popover" data-trigger="hover" data-placement="auto right" data-content="{$lang['hint_ri_tmax']}" ></i>
		  </div>
		 </div>
		<div class="form-group">
		  <label class="control-label col-md-3 col-sm-3">{$lang['rssinform_dmax']}</label>
		  <div class="col-md-9 col-sm-9">
			<input class="form-control" style="width: 4.17em;" type="text" dir="auto" name="rss_dmax" value="{$rss_dmax}" /><i class="help-button visible-lg-inline-block text-primary-600 fa fa-question-circle position-right position-left" data-rel="popover" data-trigger="hover" data-placement="auto right" data-content="{$lang['hint_ri_dmax']}" ></i>
		  </div>
		 </div>
...
<div class="panel panel-default">
  ...
  <div class="table-responsive">
    ...
    <table class="table table-xs table-hover">
      <thead>
      <tr>
        <th style="width: 13.89em">{$lang['banners_tag']}</th>
        <th>{$lang['static_descr']}</th>
        <th>{$lang['rssinform_template']}</th>
		<th style="width: 10.42em">&nbsp;</th>
