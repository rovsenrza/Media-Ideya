...
<div class="panel panel-default">
  ...
  <div class="table-responsive">
    ...
    <table class="table table-xs">
      <thead>
      <tr>
        <th style="width: 12.5em">{$lang['opt_complaint_3']}</th>
        <th>{$lang['opt_complaint_2']}</th>
		<th style="width: 17.36em">{$lang['user_action']}</th>
        <th style="width: 2.78em"><input type="checkbox" name="master_box" title="{$lang['edit_selall']}" onclick="javascript:ckeck_uncheck_all()" class="icheck"></th>
      </tr>
      </thead>
	  <tbody>
HTML;
  ...
  <div class="table-responsive">
    ...
    <table class="table table-xs">
      ...
      <tr>
        ...
        <th>{$lang['opt_complaint_2']}</th>
		<th style="width: 17.36em">{$lang['user_action']}</th>
        <th style="width: 2.78em"><input type="checkbox" name="master_box" title="{$lang['edit_selall']}" onclick="javascript:ckeck_uncheck_all2()" class="icheck"></td>
      </tr>
      </thead>
	  <tbody>
HTML;
...
while($row = $db->get_row()) {
	...
	if ( filter_var( $row['from'], FILTER_VALIDATE_IP, FILTER_FLAG_IPV4) OR filter_var( $row['from'], FILTER_VALIDATE_IP, FILTER_FLAG_IPV6) ) {
		...
		if( $row['email'] AND is_valid_email($row['email']) ) {
			...
			$email = htmlspecialchars(sanitize_email($row['email']), ENT_QUOTES, 'UTF-8');
  ...
  <div class="table-responsive">
    ...
    <table class="table table-xs">
      ...
      <tr>
        ...
        <th>{$lang['opt_complaint_2']}</th>
		<th style="width: 17.36em">{$lang['user_action']}</th>
        <th style="width: 2.78em"><input type="checkbox" name="master_box" title="{$lang['edit_selall']}" onclick="javascript:ckeck_uncheck_all3()" class="icheck"></th>
      </tr>
      </thead>
	  <tbody>
HTML;
  ...
  <div class="table-responsive">
    ...
    <table class="table table-xs">
      ...
      <tr>
        ...
        <th>{$lang['opt_complaint_2']}</th>
		<th style="width: 17.36em">{$lang['user_action']}</th>
        <th style="width: 2.78em"><input type="checkbox" name="master_box" title="{$lang['edit_selall']}" onclick="javascript:ckeck_uncheck_all4()" class="icheck"></td>
      </tr>
      </thead>
	  <tbody>
HTML;
