...
if( $_GET['action'] == "views" AND $_GET['id']) {
	...
	$entry = "<div style=\"width:100%; max-width:34.72em;\">$entry</div>";
...
.voteprogress {
  ...
  box-shadow: inset 0 1px .139em rgba(0, 0, 0, 0.1);
  border-radius: .28em;
}
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
		...
		<div class="form-group">
		  ...
		  <div class="col-md-10 col-sm-9">
			<textarea dir="auto" class="classic width-500" rows="9" name="body" id="body">{$body}</textarea>
		  </div>
		 </div>
		<div class="form-group">
