	...
	<div class="row box-section">	
	  <div class="col-sm-6 media-list media-list-linked">
		<a class="media-link" href="?mod=editusers&action=list">
			<div class="media-left"><img src="public/adminpanel/images/uset.png" class="img-lg section_icon"></div>
	  ...
	  <div class="col-sm-6 media-list media-list-linked">
		<a class="media-link" href="?mod=banners">
			<div class="media-left"><img src="public/adminpanel/images/rkl.png" class="img-lg section_icon"></div>
			<div class="media-body">
	...
	<div class="row box-section">	
	  ...
	  <div class="col-sm-6 media-list media-list-linked">
		<a class="media-link" href="?mod=newsletter">
			<div class="media-left"><img src="public/adminpanel/images/nset.png" class="img-lg section_icon"></div>
			<div class="media-body">
	...
	<div class="row box-section">	
	  <div class="col-sm-6 media-list media-list-linked">
		<a class="media-link" href="?mod=static">
			<div class="media-left"><img src="public/adminpanel/images/spset.png" class="img-lg section_icon"></div>
			<div class="media-body">
	  ...
	  <div class="col-sm-6 media-list media-list-linked">
		<a class="media-link" href="?mod=clean">
			<div class="media-left"><img src="public/adminpanel/images/clean.png" class="img-lg section_icon"></div>
			<div class="media-body">
	...
	<div class="row box-section">	
	  <div class="col-sm-6 media-list media-list-linked">
		<a class="media-link" onclick="check_files('lokal'); return false;" href="#">
			<div class="media-left"><img src="public/adminpanel/images/shield.png" class="img-lg section_icon"></div>
			<div class="media-body">
	  ...
	  <div class="col-sm-6 media-list media-list-linked">
		<a class="media-link" href="?mod=options&action=options">
			<div class="media-left"><img src="public/adminpanel/images/next.png" class="img-lg section_icon"></div>
			<div class="media-body">
...
<!--
		function check_files ( folder ){
			...
			if (folder == "snap") {
				...
				DLEconfirm( '{$lang['anti_snapalert']}', '{$lang['p_confirm']}', function () {
					...
					ShowLoading('');		
					$.post('index.php?controller=ajax&mod=antivirus', { folder: folder, user_hash: '{$dle_login_hash}' }, function(data){
		...
		$(function(){
			...
			$('#clearbutton').click(function() {
				...
				$.get("index.php?controller=ajax&mod=adminfunction&action=clearcache&user_hash={$dle_login_hash}", function( data ){
			...
			$('#clearsubscribe').click(function() {
			    ...
			    DLEconfirm( '{$lang['confirm_action']}', '{$lang['p_confirm']}', function () {
					...
					$.get("index.php?controller=ajax&mod=adminfunction&action=clearsubscribe&user_hash={$dle_login_hash}", function( data ){
						DLEPush.info(data);
					});
				} );
				return false;
			...
			$('#check_updates').click(function() {
				...
				$.get("index.php?controller=ajax&mod=updates&versionid={$currect_version}&user_hash={$dle_login_hash}&build={$currect_build}", function( data ){
					HideLoading('');
					...
					if(data.need_update === false && data.message) {
					...
					if (!data.message) {
						DLEPush.error('{$lang['no_update']}');
						return;
					}

					$("#dlepopup").remove();

					$("body").append("<div id='dlepopup' class='dle-update' title='{$lang['all_info']}' style='display:none'>"+ data.message +"</div>");
					...
					if(data.auto_update) {
						b['{$lang['update_run']}'] = function() { 

							document.location= '?mod=upgrade';
					...
					$('#dlepopup').dialog({
						...
						HideLoading('');
						DLEPush.error(jqXHR.responseText);
			...
			$('#send_notice').click(function() {
				...
				$.post("index.php?controller=ajax&mod=adminfunction&action=sendnotice&user_hash={$dle_login_hash}", { notice: notice } , function( data ){
					HideLoading('');
					DLEPush.info(data);
				});
				return false;
...
echo <<<HTML
                     ...
                     <div class="tab-pane has-padding" id="notinfo">
							<textarea id="notice" name="notice" dir="auto" class="classic" style="width:100%;height:13.89em;" placeholder="{$lang['main_no_notice']}">{$row['notice']}</textarea>
...
HTML;
	...
	if (@file_exists("install.php")) {
		echo "<script>$(function(){DLEPush.error('{$lang['stat_install']}', '', 30000);});</script>";
	}

	if( !is_writable( ENGINE_DIR . "/cache/" ) OR !is_writable( ENGINE_DIR . "/cache/system/" ) ) {
		echo "<script>$(function(){DLEPush.warning('{$lang['stat_cache']}', '', 30000);});</script>";
	}
	
	if( $dfs AND $dfs < 20240 ) {
		echo "<script>$(function(){DLEPush.warning('{$lang['stat_nofree']}', '', 30000);});</script>";
	}
	
	if (!defined( 'SECURE_AUTH_KEY' ) OR strlen(SECURE_AUTH_KEY) < 20 ) {
		echo "<script>$(function(){DLEPush.error('{$lang['stat_sec_auth']}', '', 30000);});</script>";
	}
	
	if (get_ip() == "not detected" ) {
		echo "<script>$(function(){DLEPush.error('{$lang['stat_sec_ip']}', '', 30000);});</script>";
	}
	...
	if( !$image_driver ) {
		echo "<script>$(function(){DLEPush.warning('{$lang['stat_not_min']} GD2 (<a href=\"https://www.php.net/manual/en/book.image.php\" target=\"_blank\">https://www.php.net/manual/en/book.image.php</a>)', '', 30000);});</script>";
	}

	if( !function_exists( 'simplexml_load_string' ) ) {
		echo "<script>$(function(){DLEPush.warning('{$lang['stat_not_min']} SimpleXML (<a href=\"https://www.php.net/manual/en/book.simplexml.php\" target=\"_blank\">https://www.php.net/manual/en/book.simplexml.php</a>)', '', 30000);});</script>";
	}

	if( !class_exists('ZipArchive') ) {
		echo "<script>$(function(){DLEPush.warning('{$lang['stat_not_min']} Zip (<a href=\"https://www.php.net/manual/en/book.zip.php\" target=\"_blank\">https://www.php.net/manual/en/book.zip.php</a>)', '', 30000);});</script>";
	}
	
	if (!function_exists('gzencode')) {
		echo "<script>$(function(){DLEPush.warning('{$lang['stat_not_min']} Zlip (<a href=\"https://www.php.net/manual/en/book.zlib.php\" target=\"_blank\">https://www.php.net/manual/en/book.zlib.php</a>)', '', 30000);});</script>";
	}

	if( !@extension_loaded('curl') ) {
		echo "<script>$(function(){DLEPush.warning('{$lang['stat_not_min']} CURL (<a href=\"https://www.php.net/manual/en/book.curl.php\" target=\"_blank\">https://www.php.net/manual/en/book.curl.php</a>)', '', 30000);});</script>";
	}
	
	if (!function_exists('exif_read_data')) {
		echo "<script>$(function(){DLEPush.warning('{$lang['stat_not_min']} EXIF (<a href=\"https://www.php.net/manual/en/book.exif.php\" target=\"_blank\">https://www.php.net/manual/en/book.exif.php</a>)', '', 30000);});</script>";
	}

	if (!function_exists('finfo_file')) {
		echo "<script>$(function(){DLEPush.warning('{$lang['stat_not_min']} FileInfo (<a href=\"https://www.php.net/manual/en/book.fileinfo.php\" target=\"_blank\">https://www.php.net/manual/en/book.fileinfo.php</a>)', '', 30000);});</script>";
	}

	if (!function_exists('mb_convert_encoding')) {
		echo "<script>$(function(){DLEPush.warning('{$lang['stat_not_min']} mbstring (<a href=\"https://www.php.net/manual/en/book.mbstring.php\" target=\"_blank\">https://www.php.net/manual/en/book.mbstring.php</a>)', '', 30000);});</script>";
	}
	
	if (!class_exists('Transliterator')) {
		echo "<script>$(function(){DLEPush.warning('{$lang['stat_not_min']} Intl (<a href=\"https://www.php.net/manual/en/intl.installation.php\" target=\"_blank\">https://www.php.net/manual/en/intl.installation.php</a>)', '', 30000);});</script>";
	}
	...
	if( defined('DLE_PHP_MIN') AND !DLE_PHP_MIN ) {
		...
		echo "<script>$(function(){DLEPush.error('{$lang['stat_phperror']}', '', 30000);});</script>";
	}
