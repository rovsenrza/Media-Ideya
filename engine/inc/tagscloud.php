...
if ( count($tags) ) {
	...
	foreach ($list as $value) {
		...
		$link = "<a href=\"" . DLEUrl::BuildUrl('tags', ['tag' => rawurlencode(dle_strtolower($url_tag))]) . "\" target=\"_blank\"><i class=\"fa fa-eye position-left\"></i>" . $lang['comm_view'] . "</a>";
...
<div class="box-content">
    <table class="table table-xs table-hover">
      ...
      <tr>
        ...
        <th class="text-center{$caret['count']}" style="width: 13.89em;">{$lang['tagscloud_count']} <a onclick="javascript:order_submit('count', '{$order_by}'); return(false);" href="#"><span class="caret"></a></span</th>
...
<table width="100%">
    <tr>
        <td style="height:3.47em;"><div align="center">{$lang['tagscloud_not_found']}</div></td>
    </tr>
</table>
</div>
HTML;
