...
if( $_POST['action'] == "doadd" ) {
	...
	if( !check_referer($_SERVER['SCRIPT_NAME']."?mod=banners") ) {
  ...
  <div class="panel-body">
		...
		<div class="form-group">
		  ...
		  <div class="col-md-9 col-sm-9">
			<select name="grouplevel[]" class="cat_select" data-placeholder="{$lang['group_select_1']}" style="width:17.36em;" multiple><option value="all" {$check_all}>{$lang['edit_all']}</option>{$groups}</select>
		  </div>
		</div>
		<div class="form-group">
		  <label class="control-label col-md-3 col-sm-3">{$lang['banner_dev']}</label>
		  <div class="col-md-9 col-sm-9">
			<select name="devicelevel[]" class="cat_select" data-placeholder="{$lang['group_select_2']}" style="width:17.36em;" multiple><option value="all" {$check_all_1}>{$lang['edit_all']}</option>{$devicelevel}</select>
		  </div>
		</div>
...
HTML;
	...
	if( $entries ) {
		$th_head = <<<HTML
      <tr>
        <td class="no-border" style="width: 11.81em">{$lang['static_descr']}</td>
        <td id="codelist" class="hidden-xs no-border">&nbsp;</td>
		<td class="no-border text-center" style="width: 4.17em;"><i class="fa fa-eye tip" data-original-title="{$lang['st_views']}"></i></td>
		<td class="no-border text-center" style="width: 4.17em;"><i class="fa fa-hand-pointer-o tip" data-original-title="{$lang['banner_counts_3']}"></i></td>
        <td class="no-border" style="width: 2.08em"></td>
        <td class="no-border" style="width: 4.86em">&nbsp;</td>
      </tr>
HTML;
...
HTML;
			...
			<tr>
			 ...
			 <td class=\"{$border}text-center\" style=\"width: 4.86em\">{$menu_link}</td>
		   </tr>";
