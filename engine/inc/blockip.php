	...
	<input type="hidden" name="user_hash" value="{$dle_login_hash}">
      ...
      <div class="modal-body">
		...
		<div class="form-group">
		  ...
		  <div class="col-sm-8">
			<input  class="form-control" style="width:13.19em;" data-rel="calendar" type="text" dir="auto" name="date" autocomplete="off">
		  </div>
		 </div>
		<div class="form-group">
...
echo <<<HTML
  <div class="table-responsive">
    <table class="table table-striped table-xs table-hover">
      <thead>
      <tr>
        <th style="width: 13.89em">{$lang['title_filter']}</th>
        <th style="width: 13.19em">{$lang['ban_date']}</th>
...
<table width="100%">
    <tr>
        <td style="height:3.47em;"><div align="center">{$lang['ip_empty']}</div></td>
    </tr>
</table>
</div>
<div class="panel-footer">
