...
class MobileDetect
{
    private const MAXIMUM_USER_AGENT_LENGTH = 500;
    ...
    private const ACCEPT_MOBILE_VALUES = [
    ...
    private const TABLET_REGEX = '~\b(?:iPad|PlayBook|RIM Tablet|Windows NT [0-9.]+; ARM;.*(?:Tablet|ARMBJS)|Kindle|Silk|Nexus\s*(?:7|9|10)|Pixel C|Pixel Tablet|Google Pixel Tablet|Xoom|Nook|NookColor|Nabi|Hudl|Lifetab|MediaPad|MatePad|SmartTab|SurfTab|Pocketbook|Kobo|Tolino|Galaxy Tab|GT-P\d+|GT-N(?:5|8)\d+|SM-(?:T|P|W|X)[A-Z0-9]+|SCH-I800|SGH-I987|SPH-P100|SHW-M18|KF[A-Z0-9]+|Lenovo TAB|Idea(?:Tab|Pad)|ThinkPad Tablet|TB-[A-Z0-9-]+|Xiaomi Pad|Redmi Pad|OnePlus Pad|OPPO Pad|realme Pad|vivo Pad|HONOR Pad|MagicPad|TCL TAB|TCL NXTPAPER|Nokia T(?:10|20|21)|MeMO Pad|Transformer Pad|HP Slate|SlateBook|ElitePad|Venue (?:7|8|11)|Dell Streak (?:7|10)|Iconia|BNTV\d+|BNRV\d+|Tablet(?!.*PC)|MID(?:[ -]|$))\b~i';
    private const TABLET_RULES = [
        'Pixel Tablet|Google Pixel Tablet',
        'Xiaomi Pad|Redmi Pad|\bMI PAD\b|23046RP50C|23073RPBFG|24018RPACC|2405CRPFDG',
        'OnePlus Pad|OPD2203|OPD2304|OPD2403',
        'OPPO Pad|OPD2101|OPD2301',
        'realme Pad|RMP2102|RMP2204|RMP2205|RMP2103',
        'vivo Pad|PA2170|PA2373|PA2353',
        'HONOR Pad|MagicPad|HEY2-W09|AGM3-W09|BTK-W09',
        'MatePad|DBY2-W09|GOT-W09|WGR-W09|HEY-W09',
        'TCL TAB|TCL NXTPAPER|Nokia T10|Nokia T20|Nokia T21',
        'Blackview Tab|Oscal Pad|OUKITEL (?:RT|OT)|DOOGEE (?:T|U)\d+|ALLDOCUBE|Alldocube|CHUWI|Headwolf|UMIDIGI G[0-9]+ Tab',
        'iPad|iPad.*Mobile',
        ...
        'MediaPad|MediaPad 7 Youth|IDEOS S7|S7-201c|S7-202u|S7-101|S7-103|S7-104|S7-105|S7-106|S7-201|S7-Slim|M2-A01L|BAH-L09|BAH-W09|AGS-L09|CMR-AL19|KOB2-L09|BG2-U01|BG2-W09|BG2-U03|AGS-W09',
        '\bN-06D|\bN-08D',
        'Pantech.*P4100',
    ...
    private const MOBILE_REGEX = '~\b(?:Mobile|Mobi|CrMo|iPhone|iPod|Android|Windows Phone|IEMobile|MSIEMobile|BlackBerry|BB10|Opera Mini|Opera Mobi|fennec|FxiOS|webOS|Palm|Symbian|SymbOS|Series60|Series40|S60|J2ME|MIDP|CLDC|UCWEB|UCBrowser|MicroMessenger|Nokia|SonyEricsson|Kindle|Silk|PlayBook|Tapatalk|PDA|SAGEM|Smartphone|smartfon|treo|up\.browser|up\.link|vodafone|wap|MAUI.*WAP|Tablet(?!.*PC))\b~i';
    private const MOBILE_RULES = [
        'EdgA|EdgiOS|MiuiBrowser|HeyTapBrowser|VivoBrowser|DuckDuckGo.*(?:Mobile|Android|iOS)|YaApp_Android|YaBrowser.*Mobile',
        'KaiOS|Mobile.*HuaweiBrowser|Mobile.*PaleMoon',
        'Pixel (?:[2-9]|[1-9][0-9])|Pixel [0-9]+ Pro|Pixel Fold|Pixel XL',
        'SM-(?:S|A|M|F|G|N)[A-Z0-9]+|SCG[0-9]+|SC-[0-9A-Z]+',
        'Redmi|POCO|Xiaomi|\bMi\b [0-9]|M[0-9]{3,4}[A-Z0-9]+',
        'OnePlus|CPH[0-9]{4}|NE[0-9]{4}|KB[0-9]{4}|IN[0-9]{4}|LE[0-9]{4}|GM[0-9]{4}|HD[0-9]{4}',
        'OPPO|realme|RMX[0-9]{4}|vivo|V[0-9]{4}A|PD[0-9]{4}',
        'HONOR|Magic[0-9]|ELS-[A-Z0-9]+|ANA-[A-Z0-9]+|VOG-[A-Z0-9]+|LYA-[A-Z0-9]+|NOH-[A-Z0-9]+|BLA-[A-Z0-9]+',
        'moto g|moto e|moto x|moto edge|XT[0-9]{3,4}',
        'Xperia|SO-[0-9A-Z]+|SOV[0-9]+|AQUOS|SH-[0-9A-Z]+|FCG[0-9]+',
        ...
        'IEMobile|MSIEMobile',
        'fennec|firefox.*maemo|(Mobile|Tablet).*Firefox|Firefox.*Mobile|FxiOS.*Mobile',
        'bolt',
        'teashark',
        'Blazer',
        ...
        'Asus.*Galaxy|PadFone.*Mobile|ASUS_Z01QD|ASUS_X00TD',
    ...
    private const FALLBACK_HINT_REGEX = '~\b(?:CrMo|CriOS|EdgA|EdgiOS|FxiOS|Fennec|Opera Mini|Opera Mobi|Coast|Skyfire|Bolt|TeaShark|Blazer|Dolfin|Mercury|Obigo|NF-Browser|NetFront|DiigoBrowser|HuaweiBrowser|MiuiBrowser|HeyTapBrowser|VivoBrowser|YaApp_Android|DuckDuckGo|MicroMessenger|UCWEB|UCBrowser|baiduboxapp|baidubrowser|Nokia|NokiaBrowser|OviBrowser|OneBrowser|TwonkyBeamBrowser|MQQBrowser|Mobile Safari|MobileSafari|SEMC|FlyFlow|Minimo|Novarra|Sailfish|MeeGo|Maemo|KaiOS|HarmonyOS|webOS|hpwOS|bada|BREW|BlackBerry|BB10|Palm|PalmOS|AvantGo|blazer|elaine|hiptop|plucker|xiino|Symbian|SymbOS|SYB-[0-9]+|Series60|Series40|J2ME|MIDP|CLDC|Windows Phone|Windows Mobile|WCE;|XBLWP7|ZuneWP7|IEMobile|MSIEMobile|HTC|Qtek|ADR[0-9]+|PG[0-9]+|APX[0-9A-Z]+|Sensation|Desire|Evo|Vision|Explorer|Inspire 4G|T-Mobile G1|Nexus|DROID|MOT-|Motorola|Moto|XT[0-9]{3,4}|MB[0-9]{3}|ME[0-9]{3}|MT[0-9]{3}|WX[0-9]{3}|A[0-9]{4}|Pixel|Dell|XCD[0-9]+|SM-[A-Z0-9]+|GT-[A-Z0-9]+|SGH-|SCH-|SPH-|SHW-|SCS-|SWC-|BGT-|LG[- ]|LM-G|\bLG\b|Sony(?:ST|LT|Ericsson)|Xperia|LT[0-9]+|C5303|C690[236]|D2533|SOV[0-9]+|601SO|F8332|ASUS_|PadFone|Redmi|POCO|Xiaomi|N2G47H|Micromax|Lumia|Vertu|PANTECH|IM-A[0-9]+|VEGA|PT[0-9]+|P[0-9]{4}|Fly|IQ[0-9]{3}|Wiko|KITE|HIGHWAY|GETAWAY|STAIRWAY|DARKSIDE|DARKFULL|DARKNIGHT|DARKMOON|RAINBOW|BLOOM|SUNSET|LENNY|BARRY|IGGY|OZZY|CINK|i-mobile|SP-[0-9]{2,4}|SPX-|SPT-|AT-(?:B|AS)[A-Z0-9]+|Alcatel|Nintendo (?:3DS|Switch)|Amoi|INQ|OnePlus|CPH[0-9]{4}|OPPO|realme|RMX[0-9]{4}|vivo|HONOR|HUAWEI|HMSCore|Tapatalk|PDA|SAGEM|Smartphone|smartfon|treo|up\.browser|up\.link|vodafone|wap|mmp|pocket|psp|N900|MAUI)\b~i';
    private const TV_REGEX = '~\b(?:Android TV|Google TV|GoogleTV|Apple ?TV|tvOS|Roku|Roku/DVP|RokuOS|SMART-TV|SmartTV|HbbTV|Tizen|Web0S|webOS(?:\.TV)?|NetCast|BRAVIA|SonyDTV|AQUOS|VIERA|VIDAA|SmartCast|Fire ?TV|AFT[A-Z0-9]+|Chromecast|CrKey|SHIELD Android TV|SHIELD TV|Nexus Player|MiBOX|MIBOX|Mi Box|MiTV|Mi TV|Xbox|PlayStation|DuneHD|Dune HD|Zidoo|MAG[0-9]+)\b~i';
    private const TV_HINT_REGEX = '~\b(?:TV|DTV|HDTV|ATV|SmartTV|SMART-TV|HbbTV|Tizen|Web0S|webOS|NetCast|Roku|AppleTV|tvOS|FireTV|AFT[A-Z0-9]+|Chromecast|CrKey|BRAVIA|AQUOS|VIERA|VIDAA|SmartCast|VIZIO|PhilipsTV|NetTV|OIPF|CE-HTML|CEHTML|DIAL|DLNADOC|Maple|Orsay|Seraphic|Oregan|Espial|InettvBrowser|WebMAF|Vewd|Opera TV|Nettv|NetRange|SHIELD|MiBOX|MIBOX|MiTV|MDZ-|Nexus Player|ADT-1|DuneHD|Zidoo|Zappiti|R_volution|MAG[0-9]+|Dreambox|Formuler|Amino|Humax|Kaon|Sky Q|Xfinity|Freebox|SberBox|Yandex TV|X96|H96|T95|Tanix|Mecool|Beelink|MINIX|Ugoos|Vontar|HK1|A95X|MXQ|M8S|Xbox|PlayStation|Nintendo Switch|WiiU)\b~i';
    private const TV_RULES = [
        'Android[ ._-]*TV|Google[ ._-]*TV|GoogleTV|Google TV Streamer|Chromecast with Google TV|ADT-1|Nexus Player|Nexus Q',
        'AppleTV|Apple TV|tvOS|AppleCoreMedia.*Apple TV',
        'Roku|Roku/DVP|RokuOS|RokuBrowser|Roku Streaming Stick|Roku Express|Roku Premiere|Roku Ultra|Roku TV|NowTV|Now TV',
        'AFT[A-Z0-9]+|Amazon Fire TV|Fire TV|FireTV|KFTT.*Silk|AFTB|AFTS|AFTM|AFTT|AFTN|AFTA|AFTSS|AFTMM|AFTSO|AFTKA|AFTKM|AFTJMST12|AFTWS',
        'SMART-TV|SmartTV|Smart-TV|Smart TV|Internet TV|Connected TV|HbbTV|Hybridcast|HybridCast|OIPF|OIPF[ /]1|CE-HTML|CEHTML|DIAL|DLNADOC|DLNA',
        'Tizen.*TV|SMART-TV.*Tizen|Samsung.*(?:SmartTV|SMART-TV|TV)|Maple(?:Browser)?|SmartHub|SmartHubTV|Orsay',
        'Web0S|webOS(?:\\.TV)?|LG Smart TV|LG NetCast|NetCast|LG Browser.*TV|LGE.*(?:TV|NetCast)|LGTV|LG DTV',
        'BRAVIA|SonyDTV|Sony TV|SonyCEBrowser|SonyCEBrowser.*DTV|Sony KDL|Sony KD-|Sony XR-|Sony XBR|Sony Android TV',
        'AQUOS|AQUOSBrowser|Sharp.*(?:TV|AQUOS)|SharpDTV|SHARP SmartTV',
        'VIERA|VieraCast|Panasonic.*(?:TV|VIERA)|PanasonicDTV|Panasonic.*NetTV',
        'PhilipsTV|Philips TV|Philips.*(?:SmartTV|NetTV|TV)|NETTV|NetTV|TPVision|TP Vision|Saphi|PhilipsAndroidTV',
        'Hisense|VIDAA|VIDAA TV|Hisense.*(?:TV|VIDAA)|Vewd.*Hisense|Opera TV.*Hisense',
        'VIZIO|Vizio|Vizio SmartCast|SmartCast|VIZIO.*TV|Vizio.*TV',
        'TCL.*(?:TV|SmartTV|Roku)|TCL Roku TV|TCL Google TV|TCL Android TV',
        'Skyworth|Skyworth.*TV|Coocaa|Coolita|Changhong|Konka|Haier.*TV|Grundig.*TV|Loewe.*TV|Vestel|VESTEL|JVC.*TV|Thomson.*TV|Telefunken.*TV|KIVI.*TV|Hyundai.*TV|Prestigio.*TV',
        'Opera TV|OperaTV|Oregan|Seraphic|Espial|Vewd|NetRange|InettvBrowser|DTVNetBrowser|OpenTV|WPE(?:WebKit)?|WebMAF|NetFront.*(?:TV|DTV|NX)|HbbTV.*(?:CE-HTML|OIPF)',
        'NVIDIA SHIELD|SHIELD Android TV|SHIELD TV|NVIDIA.*Foster|NVIDIA.*Darcy|NVIDIA.*Sif',
        'MiBOX|MIBOX|Mi Box|MiTV|Mi TV|MiTV Stick|Xiaomi TV|Xiaomi.*(?:Mi Box|TV Stick)|MDZ-[0-9A-Z-]+|MIBOX[0-9A-Z-]*',
        'Onn\\.?(?: 4K)? (?:Streaming Box|Google TV)|onn\\.?(?: TV| UHD| Streaming)|Dynalink.*(?:TV|Box)|Walmart.*onn',
        'Homatics|SEI Robotics|SEI[ -]?TV|Strong Leap|Nokia Streaming Box|Nokia Streaming Stick|Nokia Media Streamer|Thomson THA[0-9]+|Ematic Jetstream|EKO Android TV',
        'Mecool|MECOOL|KM1|KM2|KM3|KM6|KM7|KM9|KD1|KA1|KT1|Kii Pro|KIII Pro',
        'Beelink|MINIX|Ugoos|Vontar|Tanix|TOX1|HK1|A95X|X96|X88|H96|T95|MXQ|M8S|Tox[0-9]*|Magicsee|Vorke|Alfawise|Bqeel|Pendoo|T95Z|TX3|TX5|TX6|TX9',
        'Amlogic|S805|S812|S905|S905X|S905W|S905Y|S912|S922X|A311D|RK3318|RK3328|RK3399|RK3566|RK3568|Allwinner H3|Allwinner H6|Allwinner H616|Allwinner H618',
        'DuneHD|Dune HD|Zidoo|Zappiti|R_volution|Egreat|Himedia|Popcorn Hour|Xtreamer|Mede8er|Naim|NaimMuSo',
        'MAG[0-9]+|Infomir|AuraHD|Amino|Amino.*(?:STB|TV)|Dreambox|Vu\\+|VUPLUS|Formuler|BuzzTV|Buzz TV|Openbox|Octagon SF|GigaBlue|Enigma2|Enigma 2',
        'Humax|Kaon|ARRIS.*(?:STB|TV)|Arris.*(?:STB|TV)|Technicolor.*(?:STB|TV)|Cisco.*(?:STB|TV)|Sagemcom.*(?:STB|TV)|Mediaroom|Minerva|Entone|Motorola.*(?:STB|DCT|DCH|VIP)',
        'Sky Q|SkyQ|Sky Glass|Sky Stream|Xfinity|Comcast|XiOne|Xi6|XClass TV|Freebox Player|Freebox TV|Orange TV|Bouygues Bbox|SFR Box|CanalSat|CanalPlus|Canal\\+',
        'SberBox|SberPortal|Sber.*TV|Yandex TV|Yandex Module|YaOS|YNDX-[A-Z0-9-]+|Wink.*(?:Box|TV)|Okko.*(?:Box|SmartBox)|KION.*(?:Box|TV)',
        'Xbox|Xbox One|Xbox Series X|Xbox Series S|XboxSeries|PlayStation 3|PlayStation 4|PlayStation 5|PS3|PS4|PS5|Nintendo Switch|Nintendo WiiU|WiiU|Nintendo Wii',
        '(?:^|[;()/ ])(?:TV|DTV|HDTV|ATV|STB|SetTopBox|Set-top box)(?:[;()/ ]|$)',
    ];
    private const ANDROID_TV_REGEX = '~\b(?:TV|SMART-TV|SmartTV|AFT[A-Z0-9]+|BRAVIA|HbbTV|CrKey|Tizen|NetCast)\b~i';

    private string $userAgent = '';
    private bool $headerMobile = false;
    private bool $cloudFrontMobile = false;
    private bool $cloudFrontTablet = false;
    private bool $cloudFrontTV = false;
    ...
    {
        if (($config['autoInitOfHttpHeaders'] ?? true) !== false) {
            $this->initFromServer();
        }
    }
    ...
    public function setUserAgent(string $userAgent): string
    {
        ...
        return $this->userAgent = substr(trim($userAgent), 0, self::MAXIMUM_USER_AGENT_LENGTH);
    }
    ...
    private function initFromServer(): void
    {
        ...
        foreach (self::UA_HEADERS as $header) {
            if (isset($_SERVER[$header]) && !is_array($_SERVER[$header])) {
                $userAgent .= (string) $_SERVER[$header] . ' ';
            }
        }

        $this->setUserAgent($userAgent);
        $this->headerMobile = $this->hasMobileHeader();
        $this->cloudFrontMobile = $this->serverHeaderIsTrue('HTTP_CLOUDFRONT_IS_MOBILE_VIEWER');
        $this->cloudFrontTablet = $this->serverHeaderIsTrue('HTTP_CLOUDFRONT_IS_TABLET_VIEWER');
        $this->cloudFrontTV = $this->serverHeaderIsTrue('HTTP_CLOUDFRONT_IS_SMARTTV_VIEWER');
    }
    ...
    private function detect(): void
    {
        ...
        if ($this->cloudFrontTV) {
            $this->tv = true;
            return;
        }

        if ($this->userAgent === '') {
            if ($this->cloudFrontTablet) {
                $this->mobile = true;
                $this->tablet = true;
            } elseif ($this->cloudFrontMobile) {
                $this->mobile = true;
            }
        ...
        $hasIPadOsDesktopUa = str_contains($userAgent, 'Macintosh') && str_contains($userAgent, 'Mobile/') && str_contains($userAgent, 'Safari');
        $this->android = str_contains($userAgent, 'Android');
        $this->ios = str_contains($userAgent, 'iPhone')
            || str_contains($userAgent, 'iPad')
            || str_contains($userAgent, 'iPod')
            || str_contains($userAgent, 'AppleCoreMedia')
            || $hasIPadOsDesktopUa;

        if ($this->hasTVHint($userAgent) && (preg_match(self::TV_REGEX, $userAgent) === 1 || $this->matchTVRules($userAgent))) {
            $this->tv = true;
            return;
        }
        ...
        $hasDeviceToken = $this->headerMobile
            || $this->cloudFrontMobile
            || $this->cloudFrontTablet
            || str_contains($userAgent, 'Android')
            || str_contains($userAgent, 'iP')
            ...
            || str_contains($userAgent, 'BB10')
            || str_contains($userAgent, 'Opera Mini')
            || str_contains($userAgent, 'Opera Mobi')
            || str_contains($userAgent, 'Nokia')
            || str_contains($userAgent, 'SonyEricsson')
            || str_contains($userAgent, 'Symbian')
            || str_contains($userAgent, 'Series')
            || str_contains($userAgent, 'webOS')
            || str_contains($userAgent, 'Palm')
            || str_contains($userAgent, 'MIDP')
            || str_contains($userAgent, 'CLDC')
            || str_contains($userAgent, 'UCWEB')
            || str_contains($userAgent, 'UCBrowser')
            || str_contains($userAgent, 'MicroMessenger')
            || str_contains($userAgent, 'PlayBook')
            || str_contains($userAgent, 'Nexus')
            || str_contains($userAgent, 'SM-')
            || str_contains($userAgent, 'GT-P')
            || str_contains($userAgent, 'KF')
            || preg_match(self::FALLBACK_HINT_REGEX, $userAgent) === 1
            || $hasIPadOsDesktopUa;
        ...
        if ($this->ios && !str_contains($userAgent, 'iPad') && !$hasIPadOsDesktopUa) {
            $this->mobile = true;
            return;
        }

        $this->tablet = $this->cloudFrontTablet
            || str_contains($userAgent, 'iPad')
            || $hasIPadOsDesktopUa
            || preg_match(self::TABLET_REGEX, $userAgent) === 1
            || ($this->android && !str_contains($userAgent, 'Mobile') && preg_match(self::ANDROID_TV_REGEX, $userAgent) !== 1)
            || ((!$this->android || !str_contains($userAgent, 'Mobile')) && $this->matchTabletRules($userAgent));
        ...
        $this->mobile = $this->tablet
            ...
            || $this->ios
            || $this->android
            || preg_match(self::MOBILE_REGEX, $userAgent) === 1
            || $this->matchMobileRules($userAgent);
    }

    private function hasTVHint(string $userAgent): bool
    {
        return str_contains($userAgent, 'TV')
            || str_contains($userAgent, 'tvOS')
            || str_contains($userAgent, 'Roku')
            || str_contains($userAgent, 'Tizen')
            || str_contains($userAgent, 'Web0S')
            || str_contains($userAgent, 'webOS')
            || str_contains($userAgent, 'NetCast')
            || str_contains($userAgent, 'BRAVIA')
            || str_contains($userAgent, 'HbbTV')
            || str_contains($userAgent, 'AFT')
            || str_contains($userAgent, 'CrKey')
            || str_contains($userAgent, 'Chromecast')
            || str_contains($userAgent, 'SHIELD')
            || str_contains($userAgent, 'MiBOX')
            || str_contains($userAgent, 'MIBOX')
            || str_contains($userAgent, 'MDZ-')
            || str_contains($userAgent, 'Xbox')
            || str_contains($userAgent, 'PlayStation')
            || preg_match(self::TV_HINT_REGEX, $userAgent) === 1;
    }

    private function matchTVRules(string $userAgent): bool
    {
        static $regex = null;

        if ($regex === null) {
            $regex = '#(?:' . implode(')|(?:', self::TV_RULES) . ')#is';
        }

        return preg_match($regex, $userAgent) === 1;
    }

    private function matchMobileRules(string $userAgent): bool
    {
        static $regex = null;

        if ($regex === null) {
            $regex = '#(?:' . implode(')|(?:', self::MOBILE_RULES) . ')#is';
        }

        return preg_match($regex, $userAgent) === 1;
    }

    private function matchTabletRules(string $userAgent): bool
    {
        static $regex = null;

        if ($regex === null) {
            $regex = '#(?:' . implode(')|(?:', self::TABLET_RULES) . ')#is';
        }
    ...
    {
        foreach (self::MOBILE_HEADERS as $header) {
            if (!empty($_SERVER[$header])) {
                return true;
            }
        }

        if (isset($_SERVER['HTTP_ACCEPT']) && !is_array($_SERVER['HTTP_ACCEPT'])) {
            $accept = (string) $_SERVER['HTTP_ACCEPT'];

            foreach (self::ACCEPT_MOBILE_VALUES as $value) {
                if (str_contains($accept, $value)) {
                    return true;
                }
            }
        }

        if (isset($_SERVER['HTTP_UA_CPU']) && !is_array($_SERVER['HTTP_UA_CPU']) && str_contains((string) $_SERVER['HTTP_UA_CPU'], 'ARM')) {
            return true;
        }

        $secChUaMobile = $_SERVER['HTTP_SEC_CH_UA_MOBILE'] ?? $_SERVER['Sec-CH-UA-Mobile'] ?? null;

        return !is_array($secChUaMobile) && $secChUaMobile === '?1';
    }

    private function serverHeaderIsTrue(string $header): bool
    {
        return isset($_SERVER[$header]) && !is_array($_SERVER[$header]) && strtolower((string) $_SERVER[$header]) === 'true';
    }
}
