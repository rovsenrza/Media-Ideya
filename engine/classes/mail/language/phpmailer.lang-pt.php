...
$PHPMAILER_LANG['no_smtputf8']          = 'O servidor não suporta SMTPUTF8, necessário para enviar para endereços Unicode';
$PHPMAILER_LANG['imap_recommended']     = 'Não se recomenda usar o analisador de endereços simplificado. Instale a extensão PHP IMAP para uma análise RFC822 completa.';
