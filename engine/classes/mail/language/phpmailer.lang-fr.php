...
$PHPMAILER_LANG['no_smtputf8']          = 'Le serveur ne prend pas en charge SMTPUTF8, nécessaire pour envoyer vers des adresses Unicode';
$PHPMAILER_LANG['imap_recommended']     = 'L’utilisation de l’analyseur d’adresses simplifié n’est pas recommandée. Installez l’extension PHP IMAP pour une analyse RFC822 complète.';
