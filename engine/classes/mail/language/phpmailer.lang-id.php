...
$PHPMAILER_LANG['buggy_php']            = 'Versi PHP Anda memiliki bug yang dapat menyebabkan pesan rusak. Untuk memperbaikinya, gunakan pengiriman melalui SMTP, nonaktifkan opsi mail.add_x_header di php.ini, beralih ke MacOS atau Linux, atau perbarui PHP ke versi 7.0.17+ atau 7.1.3+.';
$PHPMAILER_LANG['invalid_header']       = 'Nama atau nilai header tidak valid';
$PHPMAILER_LANG['smtp_code']            = 'Kode SMTP: ';
$PHPMAILER_LANG['smtp_code_ex']         = 'Informasi SMTP tambahan: ';
$PHPMAILER_LANG['smtp_detail']          = 'Detail: ';
$PHPMAILER_LANG['no_smtputf8']          = 'Server tidak mendukung SMTPUTF8 yang diperlukan untuk mengirim ke alamat Unicode';
$PHPMAILER_LANG['imap_recommended']     = 'Penggunaan parser alamat sederhana tidak disarankan. Pasang ekstensi PHP IMAP untuk penguraian RFC822 lengkap.';
$PHPMAILER_LANG['deprecated_argument']  = 'Argumen usang: ';
