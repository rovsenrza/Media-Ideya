...
(function() {
    ...
    const renderLatexFormulas = () => {
        ...
        const selector = '[data-math-type="latex"]';
        
        if (window.jQuery) {
            jQuery(selector).each(function() {
                const $el = jQuery(this);
                const formula = $el.attr('data-math');
                const isBlock = $el.hasClass('mathml-block');
                ...
                if (formula) {
                    try {
                        ...
                        console.error('Error in KaTeX:', err);
                    }
                }
            });
        } else {
            ...
            elements.forEach(el => {
                ...
                const isBlock = el.classList.contains('mathml-block');
    ...
    if (window.jQuery) {
        ...
        if (document.readyState === 'loading') {
            document.addEventListener('DOMContentLoaded', renderLatexFormulas);
        } else {
            renderLatexFormulas();
        }
    }
