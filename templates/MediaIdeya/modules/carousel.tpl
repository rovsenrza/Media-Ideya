	...
	<div class="carousel-inner" role="listbox">
		<div class="item active">
			<div class="carousel-caption">
				<div class="carousel-caption_in">
					<div class="title">DataLife Engine 20.0</div>
		...
		<div class="item">
			<div class="carousel-caption">
				<div class="carousel-caption_in">
					<div class="title">DataLife Engine 20.0</div>
					<div class="text">{{Creating your own website is easy and convenient!}}</div>
				</div>
			</div>
		...
		<div class="item">
			<div class="carousel-caption">
				<div class="carousel-caption_in">
					<div class="title">DataLife Engine 20.0</div>
					<div class="text">{{Your own website is the fastest and has the least load!}}</div>
				</div>
			</div>
