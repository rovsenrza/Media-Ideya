<section class="mi-about" id="about" aria-label="О компании" data-about-scroll>
	<div class="mi-about__track">
		<div class="mi-about__pin">
			...
			<div class="mi-about__inner">
				...
				<div class="mi-about__stats">
					<div class="mi-about__stat" data-about-stat="0">
						<div class="mi-about__stat-num">
							<img class="mi-about__wreath" src="{THEME}/images/about/wreath.svg" alt="" width="51" height="95" decoding="async">
							<span>7+</span>
							<img class="mi-about__wreath mi-about__wreath--flip" src="{THEME}/images/about/wreath.svg" alt="" width="51" height="95" decoding="async">
						</div>
						<p class="mi-about__stat-label">лет на рынке</p>
					</div>
					<div class="mi-about__stat" data-about-stat="1">
						<div class="mi-about__stat-num">
							<img class="mi-about__wreath" src="{THEME}/images/about/wreath.svg" alt="" width="51" height="95" decoding="async">
							<span>50+</span>
							<img class="mi-about__wreath mi-about__wreath--flip" src="{THEME}/images/about/wreath.svg" alt="" width="51" height="95" decoding="async">
						</div>
						<p class="mi-about__stat-label">проектов</p>
					</div>
					<div class="mi-about__stat" data-about-stat="2">
						<div class="mi-about__stat-num">
							<img class="mi-about__wreath" src="{THEME}/images/about/wreath.svg" alt="" width="51" height="95" decoding="async">
							<span>7+</span>
							<img class="mi-about__wreath mi-about__wreath--flip" src="{THEME}/images/about/wreath.svg" alt="" width="51" height="95" decoding="async">
			...
			<div class="mi-about__cover" aria-hidden="true">
				<img class="mi-about__cover-wave" src="{THEME}/images/about/wave.svg" alt="" width="1920" height="229" decoding="async">
				<div class="mi-about__cover-fill"></div>
			</div>
		</div>
	</div>
</section>
