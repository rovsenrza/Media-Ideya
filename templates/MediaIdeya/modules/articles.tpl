<section class="mi-articles" id="articles" aria-label="Статьи">
	<div class="mi-articles__inner">
		<header class="mi-section-title mi-section-title--dark">
			<h2 class="mi-section-title__heading">Разбираем рынок вслух</h2>
			<a class="mi-section-title__label" href="/">Статьи</a>
		</header>
