...
<aside class="rightside">
	...
	<!-- Latest Comments -->
	[available=main]
		[customcomments=blockmaincomments]
			<div class="block top_block">
				<h4 class="title"><b>{{Comments Block}}</b></h4>
				<ul class="lastcomm">
					{customcomments name="blockmaincomments" template="modules/lastcomments" from="0" limit="5" order="date" sort="desc" cache="yes"}
				</ul>
			</div>
		[/customcomments]
	[/available]
