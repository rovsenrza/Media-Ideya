		...
		<div class="tab-content">
			<div class="tab-pane active" id="user1">
				...
				<ul class="usinf">
					...
					<li><div class="ui-c1 grey">{{News Rating}}</div> <div class="ui-c2">{rate}</div></li>
					<li><div class="ui-c1 grey">{{Comments Rating}}</div> <div class="ui-c2">{commentsrate}</div></li>
				</ul>
				...
				<div id="options">
					<div class="addform">
						<ul class="ui-form">
							...
							[/group]
							<li class="form-group">
								<div class="user_fields">{xfields}</div>
							</li>
							<li class="form-group">
								<fieldset>
